// app/(default)/proprietaire/probleme/page.tsx
"use client";
...
export default function OwnerIncidentPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6 py-10">
      ...
      <p className="mt-1 text-gray-600">
        Créez un ticket et assignez-le à un artisan si besoin.
      </p>
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-5 rounded-xl border bg-white p-6 shadow-sm">
        ...
        <div>
          ...
          <textarea name="description" rows={4} required
                    placeholder="Détail du problème, photos prévues, disponibilité locataire, etc."
                    className="mt-1 w-full rounded-lg border px-3 py-2" />
        </div>
